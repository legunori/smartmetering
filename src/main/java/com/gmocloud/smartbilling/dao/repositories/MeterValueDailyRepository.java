 ...
 */
@Repository
public interface MeterValueDailyRepository extends JpaRepository<MeterValueDailyEntity, MeterValueDailyEntity.PKey>, JpaSpecificationExecutor<MeterValueDailyEntity> {
}
