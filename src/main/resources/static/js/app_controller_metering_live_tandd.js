...
angular.module('mainApp').controller('MeteringLiveDataTanddController', ['meteringLiveDataRest', 'listPaging', 'state', '$scope',
    function(meteringLiveDataRest, listPaging, state, $scope) {
        ...
        listPaging.triggerFunction = function() {
            ...
            return meteringLiveDataRest.getMeteringLiveDataTanddList(listPaging.mergeParam(ctrl.param), function(res) {
                /** 結果オブジェクトのプロパティ名 {
